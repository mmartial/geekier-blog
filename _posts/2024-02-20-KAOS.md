...
- [6. Troubleshooting](#6-troubleshooting)
  ...
  - [6.2. Broken after a Reboot](#62-broken-after-a-reboot)
...
Once you have it, open it an editor and perform a find and replace for the different values that you will need to customize for your setup. This will allow you to copy/paste directly from the source file.
...
- **`os.example.com`** the URL for our HTTPs upgrading reverse-proxy. 

We are not addressing choices like the use of Cinder, or values for disk size/memory/number of cores/quotas in the `my-init-runonce.sh` script or later command lines. 
...
- 20240223-1: Added missing step (ansible galaxy) and using a uniform `apt-get` 
- 20240224-1: Content clarification and changed default username. Added an "How to use this guide" and "Contribute" section
- 20240224-2: Fix display of "revision history"
