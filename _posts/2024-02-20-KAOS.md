...
- [4. KAOS](#4-kaos)
  ...
  - [4.4. Reconfigure](#44-reconfigure)
...
- [6. Troubleshooting](#6-troubleshooting)
  - [6.1. Broken after a Reboot](#61-broken-after-a-reboot)
...
sudo chown kaos.kaos /etc/kolla
...
20230223-1: Added missing step (ansible galaxy) and using a uniform `apt-get` 
